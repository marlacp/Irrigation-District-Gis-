...
holanda_centroids_shp= os.path.abspath(os.path.join(os.path.dirname(__file__),'/home/marla/Documentos/shapefiles/ShapefilexHector/shp_PmS/Holanda_PumpStation/Holanda_PumpStation_Centroids.shp'))
