...
from .views import HomePageView, ministerio_centroidsdatasets, DistrictPolygons_datasets, AyalasPump_datasets, tibasosa_centroidsdatasets, surba_centroidsdatasets, sanrafael_centroidsdatasets, pantanov_centroidsdatasets, moniquira_centroidsdatasets, surba_pump_datasets, lasvueltas_centroidsdatasets, holanda_centroidsdatasets, duitama_centroidesdatasets, cuche_centroidesdatasets, ayalas_centroidesdatasets, tibasosa_pumpdatasets, pantanov_pump_datasets, sanrafael_pump_datasets, moniquira_Pump_datasets, ministerio_Pump_datasets, country_datasets, incidence_points, DuitamaPump_datasets, Cuche_Pump_datasets, Holanda_Pump_datasets, Lasvueltas_Pump_datasets, chicamocha_riverdatasets, reservoirs_datasets
