...
duitama_centroides_shp= os.path.abspath(os.path.join(os.path.dirname(__file__),'/home/marla/Documentos/shapefiles/ShapefilexHector/shp_PmS/Duitama_PumpStation/Duitama_PumpStation_Centroids.shp'))
