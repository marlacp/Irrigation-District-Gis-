...
moniquira_pump_shp= os.path.abspath(os.path.join(os.path.dirname(__file__),'/home/marla/Documentos/shapefiles/Shapes+end/Monquira_PumpStation/Monquira_PumpStation_Polygon.shp'))
