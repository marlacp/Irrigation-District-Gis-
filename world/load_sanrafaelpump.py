...
sanrafael_pump_shp= os.path.abspath(os.path.join(os.path.dirname(__file__),'/home/marla/Documentos/shapefiles/ShapefilexHector/shp_PmS/SanRafael_PumpStation/SanRafael_PumpStation_Polygon.shp'))
