...
from .models import Incidences, Countries, DistrictP, Ayalas_Pump, tibasosa_centroids, surba_centroids, sanrafael_centroids, pantanov_centroids, moniquira_centroids, ministerio_centroids, lasvueltas_centroids, holanda_centroids, cuche_centroides, duitama_centroides, ayalas_centroides, surba_pump, tibasosa_pump, sanrafael_pump, pantanov_pump, moniquira_Pump, Duitama_Pump, Cuche_Pump, Holanda_Pump, Lasvueltas_Pump, ministerio_Pump, chicamocha_river, reservoirs
