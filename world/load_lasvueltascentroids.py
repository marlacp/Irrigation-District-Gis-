...
lasvueltas_centroids_shp= os.path.abspath(os.path.join(os.path.dirname(__file__),'/home/marla/Documentos/shapefiles/Shapes+end/LasVueltas_PumpStation/LasVueltas_PumpStation_Centroids.shp'))
